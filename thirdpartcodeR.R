...
save(results, file=paste("~/Desktop/Peter Gilbert/2018winterRA/Results/1000iter/0618corr_S1_W:",corr_S1_W,"crossover_rate:",crossover_rate,".RData", sep=""))
write.csv(nona, file=paste("~/Desktop/Peter Gilbert/2018winterRA/Results/removeNaN/0618corr_S1_W:",corr_S1_W,"crossover_rate:",crossover_rate,".csv", sep=""))
write.csv(withna, file=paste("~/Desktop/Peter Gilbert/2018winterRA/Results/includeNaN/0618corr_S1_W:",corr_S1_W,"crossover_rate:",crossover_rate,".csv", sep=""))
}
else{
  corr_S1_W = 0.5
  crossover_rate = 0.5
...
pdf(file=
    paste("Results/plots/0530_all_psi_corr_S1_W:",corr_S1_W,"crossover_rate:",crossover_rate,".pdf", sep="")) 
par(mfrow = c(1,1))
for(i in 1:11){
  ci <- cbind(results[i,1,]-qnorm(0.975)*results[i,2,], 
              results[i,1,]+qnorm(0.975)*results[i,2,])
